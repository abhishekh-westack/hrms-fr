                        ...
                        {!collapsed && (
                            <AccordionContent className="pl-11 pt-2 flex flex-col gap-2 text-sm">
                                <Link href="/organization/departments">
                                    <Button variant="ghost" className={clsx("justify-start w-full",
                                        pathname === "/organization/departments" ? "text-indigo-600 bg-blue-50" : "text-gray-700 hover:bg-gray-100")}>
                                        Departments
                                    </Button>
                                </Link>
                                ...
                                <Link href="/organization/designations">
                                    <Button variant="ghost" className={clsx("justify-start w-full",
                                        pathname === "/organization/designations" ? "text-indigo-600 bg-blue-50" : "text-gray-700 hover:bg-gray-100")}>
                                        Designations
                                    </Button>
                                </Link>
                            </AccordionContent>
